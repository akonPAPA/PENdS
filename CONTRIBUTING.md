# Contributing to Pends

Thanks for your interest in Pends — the supervised agentic Hermes pentest profile.

## How to Contribute

### Reporting Bugs

1. Check the [issues](https://github.com/Strategic-Automation/pends/issues) for duplicates
2. Include: Pends version, Hermes version, OS/platform, steps to reproduce, and any guard output
...
2. Explain the use case and how it fits Pends's supervised, authorised testing paradigm
...
2. Follow the existing file structure and conventions:
   ...
   - Hermes guard implementation belongs in `plugins/pends_guard/`; `scripts/` contains CLI and smoke helpers
...
4. Run `python scripts/pends_guard.py check-release` before opening a PR
