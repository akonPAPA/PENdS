        ...
        blockers.append(
            {
                ...
                "next_action": "Use pends_record_ptt to select and prepare a routed skill",
            }
        )
    ...
    blockers.extend(
        {
            "code": "ptt",
            "reason": error,
            "next_action": "Use pends_record_ptt to leave exactly one phase-compatible [~] task",
        }
        ...
        blockers.append(
            {
                ...
                "next_action": (
                    "Review its evidence, then call pends_review_batch with the active task"
                ),
            }
        )
            ...
            blockers.append(
                {
                    ...
                    "next_action": "Review engagement state, then call pends_heartbeat_done",
                }
            )
    return blockers
...
def _build_status_skill_summary(
    ...
    return {
        ...
        "recovery": (
            "Select a route candidate with pends_record_ptt; repeat after the preparation "
