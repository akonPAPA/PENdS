"""Declarative, fail-closed policy for Pends skill selection.
...
CATALOG: tuple[SkillSpec, ...] = (
    SkillSpec(
        "pentest", "bundled:skills/pentest", "pentest", "bundled", "included with Pends", None
    ),
    SkillSpec(
        "web-attacks",
...
def catalog_snapshot(repo_root: Path) -> dict[str, object]:
    ...
    Hermes ignores the Pends-specific audit metadata, while the later receipt
