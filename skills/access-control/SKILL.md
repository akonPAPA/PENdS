---
name: access-control
description: "Use when an authorized engagement's PTT or hypothesis identifies authentication bypass, JWT weakness, IDOR, or broken authorization. Select it through the Pends receipt flow, then load the matching playbook for controlled validation and evidence."
version: 1.0.0
author: Pends
license: MIT
metadata:
...
- [ ] Engagement bootstrapped (`pends_guard.py check-bootstrap` exit 0)
