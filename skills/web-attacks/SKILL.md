---
name: web-attacks
description: "Use when an authorized engagement's PTT or hypothesis identifies web injection: SQLi, XSS, command injection, SSRF, or path traversal. Select it through the Pends receipt flow, then load only the matching playbook for safe validation and evidence."
version: 1.0.0
author: Pends
license: MIT
metadata:
