"""Pends Reliability Roadmap 1.1.1 â€” Correctness test-plan gaps.
...
Ported to the consolidated ``plugins.pends_guard`` package (the old flat
...
_PLUGIN = ROOT / "plugins" / "pends_guard"
...
def test_hard_block_out_of_scope_never_executes(monkeypatch, tmp_path):
    """An out-of-scope target is a hard BLOCK -> pends_exec returns 'denied'
