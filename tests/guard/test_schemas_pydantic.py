"""Unit tests for Pydantic v2 schemas and validation models in plugins/pends_guard/schemas.py."""

import pytest
from pydantic import ValidationError

from plugins.pends_guard import schemas
...
def test_schema_exports_structure():
    ...
    assert schemas.EXEC_BURST_SCHEMA["name"] == "pends_exec_burst"
    assert schemas.TARGET_SCHEMA["name"] == "pends_target"
